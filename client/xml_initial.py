...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:lab="urn:oid:1.3.6.1.4.1.19376.1.3.2" xmlns:sdtc="urn:hl7-org:sdtc">
	...
	<recordTarget typeCode="RCT" contextControlCode="OP">
		<patientRole classCode="PAT">
			...
			<addr use="H"> 
				...
				<streetAddressLine>Via Prova 12</streetAddressLine> 
			</addr> 
			<addr use="HP"> 
				<country>100</country>
				<state>120</state>
				...
				<streetAddressLine>Via Prova 12B</streetAddressLine>
			</addr>			
	...
	<author> 
		...
		<assignedAuthor classCode="ASSIGNED"> 
			...
			<addr>
				...
				<streetAddressLine>Via Prova 7</streetAddressLine>
			</addr>
			<telecom use="HP" value="mailto:prova.provax@example.com"/> 
	...
	<custodian> 
		<assignedCustodian> 
			<representedCustodianOrganization>
				...
				<name>SAN RAFFAELE NOMENTANO</name>
				<telecom use="MC" value="tel:3340000000"/> 
				<addr> 
					<country>100</country>
					<state>120</state>
					...
					<streetAddressLine>Via Prova 39</streetAddressLine> 
				</addr>				
			</representedCustodianOrganization> 
		</assignedCustodian> 
	</custodian> 
		...
		<time value="20220325110000+0100"/> 
			...
			<assignedEntity>
				...
				<addr> 
					...
					<streetAddressLine>Via Prova 3</streetAddressLine>
				</addr> 
				<telecom use="HP" value="mailto:prova.provax@example.com"/> 
				<telecom use="MC" value="tel:3300000000"/> 
				<assignedPerson> 
					<name>  
						<family>Borromei</family> 
						<given>Prova</given>
						<prefix>Dttr.</prefix>
					</name> 
				</assignedPerson> 
		...
		<associatedEntity classCode="QUAL">
			...
			<scopingOrganization>
				...
				<addr> 
					...
					<censusTract>058091</censusTract>
					<postalCode>00137</postalCode> 
					<streetAddressLine>Via Di Praga 39</streetAddressLine> 
				</addr>	
			</scopingOrganization>
		</associatedEntity>
	</participant>
			...
			<performer typeCode="PRF">
				<assignedEntity>
					...
					<representedOrganization>
						...
						<name>Nuovo Ospedale S.Agostino</name>
	...
	<relatedDocument typeCode ="RPLC"> 
		<parentDocument> 
			<id root="2.16.840.1.113883.2.9.2.120.4.4" extension="030702.PROVAX00X00X000Y.20220330112426.TSS1Tkju" assigningAuthorityName="Regione Lazio"/>
			<setId root="2.16.840.1.113883.2.9.2.120.4.4" extension="c030702.PROVAX00X00X000Y.20220325112426.TSS1Tkju" assigningAuthorityName="Regione Lazio"/>
